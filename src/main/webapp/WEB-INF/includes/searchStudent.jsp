<section id="searchStudent" class="hidden flex-col">
    ...
    <table class="min-w-full border border-gray-300">
        <thead>
        <tr>
            <th class="border border-gray-200 px-8 py-2">index</th>
        ...
        <tbody>
        <tr>
            <td class="border border-gray-300 px-8 py-2"></td>
            <td class="border border-gray-300 px-8 py-2"><c:out value="${searchStudent.getNom()}" /></td>
            <td class="border border-gray-300 px-8 py-2"><c:out value="${searchStudent.getPrenom()}" /></td>
            <td class="border border-gray-300 px-8 py-2"><c:out value="${searchStudent.getCne()}" /></td>
            <td class="border border-gray-300 px-8 py-2"><c:out value="${searchStudent.getDateNaissance()}" /></td>
            <td class="border border-gray-300 px-8 py-2">
                <c:out value="${searchStudent.getAdresse()}" />
            </td>
            <td
                    class="border border-gray-300 px-4 py-2 flex flex-col lg:flex-row text-center lg:space-x-2 items-center justify-center">
                ...
                <form action="studentAction" method="post" class="text-red-400 border-2 border-red-400 px-6 py-1">
